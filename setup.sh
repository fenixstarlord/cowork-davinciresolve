...
echo ""
echo "Next steps:"
echo "  1. Restart Claude Desktop (so the MCP server picks up)"
echo "  2. Ensure DaVinci Resolve is running"
echo "  3. Start a Cowork session and go!"
echo ""
echo "To uninstall:  ./setup.sh --uninstall"
echo ""
echo "Available slash commands:"
echo "  /version            — Add custom named color versions to clips"
echo "  /version-up         — Auto-increment dated version numbers"
echo "  /transform-disable  — Disable transforms on timeline clips"
echo "  /transform-enable   — Re-enable transforms on timeline clips"
echo "  /roundtrip          — Roundtrip render: render clips, export XML, import as new timeline"
echo "  /conform            — Compare two timelines and report conformance differences"
echo "  /deliver            — Queue multi-format renders and monitor progress"
echo "  /organize           — Auto-organize media pool clips into bins by metadata"
echo "  /audit              — Inspect active timeline for common issues"
echo "  /snapshot           — Save/diff project state snapshots"
