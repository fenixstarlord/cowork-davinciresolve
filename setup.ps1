...
Write-Host "  /roundtrip          - Roundtrip render: render clips, export XML, import as new timeline"
Write-Host "  /conform            - Compare two timelines and report conformance differences"
Write-Host "  /deliver            - Queue multi-format renders and monitor progress"
Write-Host "  /organize           - Auto-organize media pool clips into bins by metadata"
Write-Host "  /audit              - Inspect active timeline for common issues"
Write-Host "  /snapshot           - Save/diff project state snapshots"
